            ...
            <div className="mx-auto w-full max-w-7xl px-8">
                <RevealOnScroll>
                    <div className="flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between border-white/10">
                        <div className="mb-4 text-center font-normal text-gray-300 md:mb-0 text-sm">
                            &copy; {currentYear}{" "}
                            <Tooltip
                                title="Created in React with ❤️ by MichalBr."
                                slots={{ transition: Zoom }}
                            >
                                <span className="cursor-help">MichalBr</span>
                            </Tooltip>
                            . All Rights Reserved.
                        </div>
                        <div className="flex gap-4 text-blue-gray-900 sm:justify-center">
                            <Tooltip title="Youtube" slots={{ transition: Zoom }}>
                                <a
                                    href="https://www.youtube.com/@MichalBr"
                                    className="opacity-80 transition-opacity hover:opacity-100 block"
                                    target="_blank"
                            ...
                            <Tooltip title="Instagram" slots={{ transition: Zoom }}>
                                <a
                            ...
                            <Tooltip title="X" slots={{ transition: Zoom }}>
                                <a
                            ...
                            <Tooltip title="Steam" slots={{ transition: Zoom }}>
                                <a
                            ...
                            <Tooltip title="GitHub" slots={{ transition: Zoom }}>
                                <a
                            ...
                            <Tooltip title="Gmail (Email)" slots={{ transition: Zoom }}>
                                <a
