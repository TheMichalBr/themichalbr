				...
				<div className="text-center z-10 px-4 max-w-4xl mx-auto">
					<div className="relative mb-8">
						<h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-5 leading-tight tracking-tight">
							<span className="bg-linear-to-br from-indigo-700 via-blue-600 to-blue-700 bg-clip-text text-transparent select-none">
								Hi, I'm MichalBr
							</span>
						</h1>
					...
					<div className="flex flex-col sm:flex-row justify-center gap-4 items-center mb-12">
						...
						>
							...
							<div className="absolute inset-0 bg-linear-to-r from-blue-600 to-cyan-600 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
						</a>
						...
						>
							...
							<div className="absolute inset-0 bg-linear-to-r from-blue-600/10 to-cyan-600/10 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
						</a>
					</div>
				</div>
			</RevealOnScroll>
