      ...
      <div className="max-w-5xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a
              href="#equipment"
              className={`text-gray-300 hover:text-white transition-colors hover:scale-102 duration-300 ${activeSection === "equipment" ? "font-bold" : ""}`}
            >
              Equipment
            </a>
            <a
              href="#games"
              className={`text-gray-300 hover:text-white transition-colors hover:scale-102 duration-300 ${activeSection === "games" ? "font-bold" : ""}`}
            >
              Games
            </a>
            <a
              href="#projects"
              className={`text-gray-300 hover:text-white transition-colors hover:scale-102 duration-300 ${activeSection === "projects" ? "font-bold" : ""}`}
            >
              Projects
            </a>
          </div>
